    ...
    <div className="min-h-[90vh] flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="text-center space-y-6 mb-16 animate-fade-in">
        ...
        <p className="max-w-lg mx-auto text-slate-400 text-lg leading-relaxed">
          Aggregate public intelligence from social profiles, technical infrastructure,
          regulatory filings, and data breaches — in seconds.
        </p>
      </div>
      ...
      <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-4 w-full max-w-2xl animate-fade-in" style={{ animationDelay: "0.2s" }}>
        {[
          ...
          { icon: Zap, label: "Parallel Fetch", desc: "All adapters run at once" },
          { icon: Database, label: "Stored Results", desc: "Full search history" },
          { icon: FileText, label: "PDF + MD Export", desc: "Professional reports" },
        ].map(({ icon: Icon, label, desc }) => (
          <div key={label} className="rounded-2xl border border-slate-800 bg-slate-900/50 p-4 text-center space-y-1.5">
